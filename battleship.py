        ...
        while True:
            ...
            if size != 1:
                ...
                if validate_ship_placement(start_pos, size, game_board):
                    ...
                    if player == 1:
                        new_ship =[start_pos]
                        p1_ship_list.append(new_ship)
                    else:
                        new_ship = [start_pos]
                        p2_ship_list.append(new_ship)
                    break
                else:
                    print(f'Invalid placement for {ship}. Try again.')
...
def run_game():
    while True:
        ...
        while True:
            ...
            if check_attack(attack_pos, p2_game_board):
                if p2_game_board[attack_row][attack_col] == 'S':
                    for i in p2_ship_list:
                        i.remove(attack_pos)
                        if len(i) == 0:
                            ship_sunk = True
                            p2_ship_list.remove(i)         
                    shot = "Hit!"
        ...
        print(shot)
        if ship_sunk == True:
            print("player 2's battleship sunk!")
            if len(p2_ship_list) == 0:
                print("Player 1 Wins!")
                break
            ship_sunk = False
        ...
        while True:
            ...
            if check_attack(attack_pos, p1_game_board):
                if p1_game_board[attack_row][attack_col] == 'S':
                    for i in p1_ship_list:
                        i.remove(attack_pos)
                        if len(i) == 0:
                            ship_sunk = True
                            p1_ship_list.remove(i)
                    shot = "Hit!"
        ...
        print(shot)
        if ship_sunk == True:
            print("player 1's battleship sunk!")
            if len(p1_ship_list) == 0:
                print("Player 2 Wins!")
                break
            ship_sunk = False
